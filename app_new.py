...
/* Compact line spacing for bank interactions only */
.compact-banks p {
...
# --- Sidebar with Shutdown ---
with st.sidebar:
    st.markdown("### ⚙️ Управление")
    if st.button("🔴 Выключить сервер", use_container_width=True):
        st.warning("Сервер будет остановлен...")
        import os
        os._exit(0)
